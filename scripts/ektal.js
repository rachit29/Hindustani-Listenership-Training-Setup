...
var radius1 = 40; //radius of accented matra
...
function preload () {
  recordingsList = loadJSON("../files/ektal.json");
...
function setup () {
  ...
  showTheka = createCheckbox(' ṭhekā', true)
    ...
    .parent("sketch-holder");
  showCursor = createCheckbox(' cursor', false)
  ...
  showCursor.attribute("disabled", "false");
